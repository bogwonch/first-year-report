...
however. The \emph{AppGuard} tool~\cite{Backes:2013vm} rewrites
...
\begin{marginfigure}
  ...
  \begin{tabular}{r c c c c c }
    \toprule
                        & \sideways{Policymaker} & \sideways{Cassandra} & \sideways{RT} & \sideways{Binder} & \sideways{SecPAL} \\
    \midrule
    Local checking      &                        &                      &               &                   &                   \\
    \addlinespace
    Explicit speakers   & \cross                 &                      &               &                   & \tick             \\
    \addlinespace
    External functions  & \tick                  &                      &               &                   & \tick             \\
    \addlinespace
    Constraints         &                        &                      &               &                   & \tick             \\
    \addlinespace
    Delegation          &                        &                      &               &                   & \tick             \\
