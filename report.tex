...
first year has focussed on learning the SecPAL language, evaluating what
...
\begin{marginfigure}
  \centering
  \includegraphics[width=\marginlength]{img/towelroot.png}
...
This example suggests that the SecPAL language can describe the
authorization decisions in Android. We have been able to describe the
installation and update scenario with relative ease.  Installation is not the
only decision we have to make on Android. Other areas include:
