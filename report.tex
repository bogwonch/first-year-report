...
\begin{marginfigure}
  ...
  \caption{Some permissions requested by the Facebook app on Android.
...
To analyze permissions and detect malware both static and dynamic analysis has
been used.  Static analysis tools infer (and occasionally enforce) complex
security properties about the code.  What is missing is the link between the
...
\begin{figure*}
  ...
  \caption{Overview of components in a mobile software platform like Android.
...
\begin{marginfigure}
  ...
  \caption{The additional warning displayed when a user attempts to install an
...
\begin{marginfigure}
  \includegraphics[width=\marginlength]{img/collusion.pdf}
...
\begin{itemize}
  \item To evaluate how users might use the policy language and their
    ...
    \begin{description}
      \item\textbf{ Given this policy can you explain in natural language what it
      ...
      \item\textbf{ Given this policy to do \emph{X} can you modify it so that it
      ...
      \item\textbf{ Here is an app.  Do you expect this app would be allowed on your
      ...
      \item\textbf{ You have asked us to install this app but we believe it fails to
